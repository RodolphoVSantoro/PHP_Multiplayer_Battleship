...
echo"<p id='jog'>Seus Barcos ".$_SESSION['NomeJ1']." </p>
<p id='jog2'>Barcos de ".$_SESSION['NomeJ2']."</p>
</div>";
...
if(isset($_POST['coorx']))
{
 ...
 if($_SESSION["CampoJogador2"][$a][$b] == 1)
 {
  $_SESSION["CampoJogador2"][$a][$b] = 3;
  $_SESSION["Acertos1"] = $_SESSION["Acertos1"] + 1;
 }
 if($_SESSION["CampoJogador2"][$a][$b] == 0)
 {
  $_SESSION["CampoJogador2"][$a][$b] = 2;
 }
 header('Location: BN(E3).php');
}
...
for($i=0;$i<$_SESSION['TamanhoCampo'];$i++)
{
  ...
  for($j=0;$j<$_SESSION['TamanhoCampo'];$j++)
  {
    ...
    if($_SESSION["CampoJogador1"][$i][$j] == 1)
    {
    echo"<td>
             <img src='agua2.jpg'>
         </td>";
